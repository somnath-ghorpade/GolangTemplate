...
replace corelab.mkcl.org/MKCLOS/coredevelopmentplatform/corepkgv2 v1.2.7 => /home/mkcl/Documents/GO_Workspace/corepkgv2

require (
	corelab.mkcl.org/MKCLOS/coredevelopmentplatform/corepkgv2 v1.2.7
